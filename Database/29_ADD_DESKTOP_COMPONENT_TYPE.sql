-- ============================================================================
-- GBS Inventory - Migration 29
-- Novo tipo DESKTOP em TBL_COMPONENT (torre tradicional; mesmo formato do
-- MINI_DESKTOP: RAM / CPU / Storage). CK_COMP_TYPE ganha 'DESKTOP' e
-- PROC_INSERT gera UID com prefixo D (D000001). Idempotente.
-- ============================================================================

-- ----------------------------------------------------------------------------
-- 1. CK_COMP_TYPE com DESKTOP
-- ----------------------------------------------------------------------------
DECLARE V_N NUMBER;
BEGIN
    ...
    EXECUTE IMMEDIATE 'ALTER TABLE TBL_COMPONENT ADD CONSTRAINT CK_COMP_TYPE ' ||
                      'CHECK (COMPONENT_TYPE IN (''RAM'',''SSD'',''HDD'',''MINI_DESKTOP'',''DESKTOP''))';
    DBMS_OUTPUT.PUT_LINE('OK: CK_COMP_TYPE recriada com DESKTOP');
END;
/

-- ----------------------------------------------------------------------------
-- 2. PACK_COMPONENT: prefixo D para DESKTOP (resto igual a migration 27)
-- ----------------------------------------------------------------------------
