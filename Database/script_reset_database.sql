-- ============================================================================
-- GBS Inventory - Reset de dados de teste
-- Mantem estrutura (tabelas, packages, sequences, constraints).
-- Apaga apenas os dados e reinicia as sequences.
-- Execute como GBS_OWNER no SQL Developer com F5.
-- ATENCAO: irreversivel. Usar apenas em ambiente de desenvolvimento.
-- ============================================================================

-- ----------------------------------------------------------------------------
-- PASSO 1: Desabilitar constraints de FK
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- PASSO 2: Apagar dados (ordem segura com FKs desabilitadas)
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- PASSO 4: Reiniciar todas as sequences
-- ----------------------------------------------------------------------------
DROP SEQUENCE SEQ_EQUIPAMENTO;          CREATE SEQUENCE SEQ_EQUIPAMENTO          START WITH 1 INCREMENT BY 1 NOCACHE NOCYCLE;
DROP SEQUENCE SEQ_EQUIPAMENTO_UPGRADE;  CREATE SEQUENCE SEQ_EQUIPAMENTO_UPGRADE  START WITH 1 INCREMENT BY 1 NOCACHE NOCYCLE;
DROP SEQUENCE SEQ_REMESSA;              CREATE SEQUENCE SEQ_REMESSA              START WITH 1 INCREMENT BY 1 NOCACHE NOCYCLE;
DROP SEQUENCE SEQ_REMESSA_ITEM;         CREATE SEQUENCE SEQ_REMESSA_ITEM         START WITH 1 INCREMENT BY 1 NOCACHE NOCYCLE;
DROP SEQUENCE SEQ_IMPORTACAO_LOG;       CREATE SEQUENCE SEQ_IMPORTACAO_LOG       START WITH 1 INCREMENT BY 1 NOCACHE NOCYCLE;
DROP SEQUENCE SEQ_WHATSAPP_LOG;         CREATE SEQUENCE SEQ_WHATSAPP_LOG         START WITH 1 INCREMENT BY 1 NOCACHE NOCYCLE;
DROP SEQUENCE SEQ_CLIENTE;              CREATE SEQUENCE SEQ_CLIENTE              START WITH 1 INCREMENT BY 1 NOCACHE NOCYCLE;
DROP SEQUENCE SEQ_INVOICE;              CREATE SEQUENCE SEQ_INVOICE              START WITH 1 INCREMENT BY 1 NOCACHE NOCYCLE;
DROP SEQUENCE SEQ_INVOICE_ITEM;         CREATE SEQUENCE SEQ_INVOICE_ITEM         START WITH 1 INCREMENT BY 1 NOCACHE NOCYCLE;
DROP SEQUENCE SEQ_COMPONENT;            CREATE SEQUENCE SEQ_COMPONENT            START WITH 1 INCREMENT BY 1 NOCACHE NOCYCLE;
...
SELECT 'TBL_COMPONENT'           AS TABELA, COUNT(*) AS TOTAL FROM TBL_COMPONENT           UNION ALL
